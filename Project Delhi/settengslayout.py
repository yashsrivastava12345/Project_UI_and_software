...
root.grid_rowconfigure(0, weight=0, minsize=screen_height / 2.75)  # Half of original row 0
root.grid_rowconfigure(1, weight=0, minsize=screen_height / 3.2)  # Other half of original row 0
...
tk.Label(root, text="<Slider>", bg="lightblue").grid(row=0, column=0, sticky="nsew", padx=5, pady=5)
tk.Label(root, text="<All body parts image>", bg="lightblue").grid(row=0, column=1, rowspan=2,columnspan=2, sticky="nsew", padx=5, pady=5)
tk.Label(root, text="<Specfic body part> image", bg="lightblue").grid(row=0, column=3, sticky="nsew", padx=5, pady=5)
tk.Label(root, text="<History panel>", bg="lightblue").grid(row=0, column=4, rowspan=2, sticky="nsew", padx=5, pady=5)
tk.Label(root, text="Company logo>", bg="lightblue").grid(row=0, column=5, sticky="nsew", padx=5, pady=5)

tk.Label(root, text="<Buttons/Checkbox>", bg="lightblue").grid(row=1, column=0, sticky="nsew", padx=5, pady=5)
tk.Label(root, text="<Therapy button>", bg="lightblue").grid(row=1, column=3, sticky="nsew", padx=5, pady=5)
tk.Label(root, text="<Different buttons>", bg="lightblue").grid(row=1, column=5, sticky="nsew", padx=5, pady=5)

tk.Label(root, text="<Start/Stop button>", bg="lightblue").grid(row=2, column=0, sticky="nsew", padx=5, pady=5)
tk.Label(root, text="<Graph>", bg="lightblue").grid(row=2, column=1, columnspan=3, sticky="nsew", padx=5, pady=5)
tk.Label(root, text="<Add favourite>", bg="lightblue").grid(row=2, column=4, sticky="nsew", padx=5, pady=5)
tk.Label(root, text="<Remove favourite>", bg="lightblue").grid(row=2, column=5, sticky="nsew", padx=5, pady=5)
