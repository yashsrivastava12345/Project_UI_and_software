...
tk.Label(root, text="<Settings button>", bg="lightblue").grid(row=0, column=5, sticky="nsew", padx=5, pady=5)
...
tk.Label(root, text="<Copyright>", bg="lightblue").grid(row=3, column=0, columnspan=5, sticky="nsew", padx=5, pady=5)
tk.Label(root, text="<back button>", bg="lightblue").grid(row=3, column=5,  sticky="nsew", padx=5, pady=5)
