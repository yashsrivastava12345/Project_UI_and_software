...
#tk.Label(root, text="Top Left", bg="lightblue").grid(row=0, column=2, sticky="nsew", padx=5, pady=5)
...
tk.Label(root, text="Top Left", bg="lightblue").grid(row=0, column=5, sticky="nsew", padx=5, pady=5)

tk.Label(root, text="Top Left", bg="lightblue").grid(row=1, column=0, sticky="nsew", padx=5, pady=5)
#tk.Label(root, text="Top Left", bg="lightblue").grid(row=1, column=1, sticky="nsew", padx=5, pady=5)
#tk.Label(root, text="Top Left", bg="lightblue").grid(row=1, column=2, sticky="nsew", padx=5, pady=5)
tk.Label(root, text="Top Left", bg="lightblue").grid(row=1, column=3, sticky="nsew", padx=5, pady=5)
#tk.Label(root, text="Top Left", bg="lightblue").grid(row=1, column=4, sticky="nsew", padx=5, pady=5)
tk.Label(root, text="Top Left", bg="lightblue").grid(row=1, column=5, sticky="nsew", padx=5, pady=5)
...
#tk.Label(root, text="Top Left", bg="lightblue").grid(row=2, column=2, sticky="nsew", padx=5, pady=5)
#tk.Label(root, text="Top Left", bg="lightblue").grid(row=2, column=3, sticky="nsew", padx=5, pady=5)
tk.Label(root, text="Top Left", bg="lightblue").grid(row=2, column=4, sticky="nsew", padx=5, pady=5)
tk.Label(root, text="Top Left", bg="lightblue").grid(row=2, column=5, sticky="nsew", padx=5, pady=5)

tk.Label(root, text="Top Left", bg="lightblue").grid(row=3, column=0, columnspan=6, sticky="nsew", padx=5, pady=5)
